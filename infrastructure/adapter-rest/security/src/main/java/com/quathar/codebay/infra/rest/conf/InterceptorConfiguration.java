...
import com.quathar.codebay.infra.rest.interceptor.ShopAuthInterceptor;
...
public class InterceptorConfiguration implements WebMvcConfigurer {
     ...
     */
    private final ShopAuthInterceptor authInterceptor;
    /**
     ...
     */
    @Autowired
    public InterceptorConfiguration(ShopAuthInterceptor authInterceptor, ManagementAuthInterceptor managementAuthInterceptor) {
