...
/**
 * <h1>Read User by Username Use Case Implementation Test</h1>
 *
 * @see ReadUserByUsernameUseCase
 * @since 2023-12-10
 * @version 1.0
 * @author Q
 */
@ExtendWith(MockitoExtension.class)
class ReadUserByUsernameUseCaseTest {

    // <<-FIELDS->>
    @Mock
    private UserRepositoryPort userRepositoryPort;
    @InjectMocks
    private ReadUserByUsernameUseCase readByUsernameUseCase;
